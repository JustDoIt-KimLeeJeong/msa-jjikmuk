...
async def order_placed(session : Session, payload : dict) :
    # 생각해보니까 비용도 같이 줘야하네.
    query.update_order(payload.user_id, payload.order_id , payload.symbol, payload.qty, payload.price, payload.side, payload.reserved_balance, payload.reserved_qty, session)
